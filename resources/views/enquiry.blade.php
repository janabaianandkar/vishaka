...
<div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">Enquiry</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7">
                    ...
                    <h3 class="mb-4" style="color:purple;">Enquiry</h3>
                    <div class="contact-form bg-secondary" style="padding: 30px;">
                        <div id="success"></div>
                        <form method="post" enctype="multipart/form-data" action="{{route('enqu.store')}}">
                            @csrf
                            ...
                            <div>
                                <button class="btn btn py-3 px-4" type="submit" id="sendMessageButton" style="background-color:purple; color:white;" name="btn">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
